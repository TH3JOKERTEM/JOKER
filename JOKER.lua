...
JOKER_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
JOKER_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
JOKER_Msg = 'امبروطور التفاعل' 
...
--------------------------------------------------------------------------------------------------------------
function SourceJOKER(msg,data) -- بداية العمل
if msg then
...
os.execute('wget https://raw.githubusercontent.com/SourceJOKER/JOKER/master/JOKER.lua')
...
--------------------------------------------------------------------------------------------------------------
if JOKER_Msg and not Special(msg) then  
local JOKER_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if JOKER_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
📥┇ [قناه السورس](http://t.me/lljokerll)
...
t = "\n⛔┇ قائمة المنع \n━━━━━━━━━━━━━\n"
for k,v in pairs(list) do  
local JOKER_Msg = database:get(bot_id.."Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..''..k..'- '..v..' » {'..JOKER_Msg..'}\n'    
end  
if #list == 0 then  
